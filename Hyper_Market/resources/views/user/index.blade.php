...
<div class="banner">
    <div class="jumbotron jumbotron-video text-center bg-dark mb-0 rounded-0">
        <video width="100%" preload="auto" loop autoplay muted>
            <source src='{{ url("assets/media/explore.mp4") }}' type='video/mp4' />
            <source src='{{ url("assets/media/explore.webm") }}' type='video/webm' />
        </video>
        <div class="container">
            <h1 class="pt-5">
                ...
                <div class="col-md-4">
                    <div class="card border-0 text-center">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                Simply click-to-buy on the product you want and submit your order when you
                            </p>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 mt-5 text-center">
                    <a href="{{ route('user.shop') }}" class="btn btn-primary btn-lg">SHOP NOW</a>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="item">
                <div class="card rounded-0 border-0 text-center">
                    ...
                    <div class="card-img-overlay d-flex align-items-center justify-content-center">
                        <!-- <h4 class="card-title">{{ $category->name_en }}</h4> -->
                        <a href="{{ route('user.shoplist',$category->id)}}" class="btn btn-primary btn-lg">{{ $category->name_en }}</a>
                    </div>
                </div>
            </div>
