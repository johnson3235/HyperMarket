            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-8 text-center mb-3">
                        <h1 class="title text-uppercase mb-2">Marketo</h1>
                        <h5>
                ...
                <div class="row justify-content-center align-items-center mt-3">
                    <div class="col-md-4">
                        <img src="{{ url('assets/img/fruits.jpg') }}" class="img-fluid">
                    </div>
                    <div class="col-md-6">
                        <h5>
                ...
                <div class="row justify-content-center align-items-center text-right mt-3">
                    ...
                    <div class="col-md-4">
                        <img src="{{ url('assets/img/vegetables.jpg') }}" class="img-fluid">
                    </div>
                </div>

                <div class="row justify-content-center align-items-center mt-3">
                    <div class="col-md-4">
                        <img src="{{ url('assets/img/fish.jpg') }}" class="img-fluid">
                    </div>
                    <div class="col-md-6">
                        <h5>
