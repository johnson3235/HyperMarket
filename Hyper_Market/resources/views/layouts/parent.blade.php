...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <img src="{{ url('$admin->image') }}" alt="User Avatar"
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <!-- Brand Logo -->
            <a href="{{route('dashboard')}}" class="brand-link text-center m-auto">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <?php $id=Auth::user()->id;?>
                        <li class="nav-item">
                            <a href="{{ route('dashboard.admins.profile',$id)}}" class="nav-link active">
                                <p>Profile</p>
                            </a>
                        </li>
