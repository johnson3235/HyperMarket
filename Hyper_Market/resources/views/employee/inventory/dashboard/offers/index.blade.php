                        ...
                        @foreach ($products as $product)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{route('employee.products.offertoggle',[$product->offer_id,$product->product_id])}}" method="post" class="form" >
                                        @csrf
                                        @method('PATCH')
                                        <input type="checkbox" name="my-checkbox" {{$product->statusess ? 'checked' : ''}}   data-off-color="danger" data-on-color="success" value= "{{$product->status}}" data-bootstrap-switch  >
